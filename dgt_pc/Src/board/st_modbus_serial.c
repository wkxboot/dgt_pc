...
#define  LOG_MODULE_NAME     "[st_modbus_serial]"

int st_modbus_serial_init(uint8_t port,uint32_t bauds,uint8_t data_bit,uint8_t stop_bit);
int st_modbus_serial_deinit(uint8_t port);
void st_modbus_serial_enable_txe_int();
void st_modbus_serial_disable_txe_int();
void st_modbus_serial_enable_rxne_int();
...
.deinit=st_modbus_serial_deinit,
.enable_txe_int=st_modbus_serial_enable_txe_int,
.disable_txe_int=st_modbus_serial_disable_txe_int,
.enable_rxne_int=st_modbus_serial_enable_rxne_int,
