...
#define LIBMODBUS_VERSION_MAJOR (0x01)

/* The minor version (2, if %LIBMODBUS_VERSION is 1.2.3) */
#define LIBMODBUS_VERSION_MINOR (0x02)

/* The micro version (3, if %LIBMODBUS_VERSION is 1.2.3) */
#define LIBMODBUS_VERSION_MICRO (0x04)

/* The full version, like 1.2.4 */
#define LIBMODBUS_VERSION        1.2.4

/* The full version, in string form (suited for string concatenation)
 */
#define LIBMODBUS_VERSION_STRING "libmodbus_rtu v1.0.0"
