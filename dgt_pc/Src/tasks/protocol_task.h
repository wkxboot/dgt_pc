...
typedef enum
{
  PROTOCOL_TASK_MSG_REQ_NET_WEIGHT=0,
  PROTOCOL_TASK_MSG_REQ_CALIBRATE_ZERO,
  PROTOCOL_TASK_MSG_REQ_CALIBRATE_FULL,
  PROTOCOL_TASK_MSG_REQ_REMOVE_TAR_WEIGHT,
  PROTOCOL_TASK_MSG_REQ_SENSOR_ID,
  PROTOCOL_TASK_MSG_REQ_VERSION,
  PROTOCOL_TASK_MSG_REQ_SET_ADDR,
  PROTOCOL_TASK_MSG_REQ_ADDR,
  PROTOCOL_TASK_MSG_RESPONSE_NET_WEIGHT,
  PROTOCOL_TASK_MSG_RESPONSE_CALIBRATE_ZERO,
  PROTOCOL_TASK_MSG_RESPONSE_CALIBRATE_FULL,
  PROTOCOL_TASK_MSG_RESPONSE_REMOVE_TAR_WEIGHT,
  PROTOCOL_TASK_MSG_RESPONSE_SENSOR_ID,
  PROTOCOL_TASK_MSG_RESPONSE_VERSION,
  PROTOCOL_TASK_MSG_RESPONSE_SET_ADDR,
  PROTOCOL_TASK_MSG_RESPONSE_ADDR
}protocol_task_msg_type_t;
